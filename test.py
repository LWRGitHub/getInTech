...
cleaned_markdown_list = remove_empty_lines(markdown_list)
print(cleaned_markdown_list)

f = open('markdown_list_test.json', 'w', encoding="utf-8")
json.dump(cleaned_markdown_list, f, indent=4)
f.close()  
